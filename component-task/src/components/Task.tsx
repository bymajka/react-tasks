...
const Task = ({ id, title, description, isCompleted, categorie, onToggle }: TaskProps) => {
    return (
        <div className={`flex flex-row items-center gap-2 bg-purple-400 w-xl rounded-md justify-between m-4 p-4 border-0 border-b-4 border-l-2 border-r-2 ${isCompleted ? 'border-green-500' : 'border-red-700'}`}>
            <div>
